...
def upload_photos_to_cloudinary(profile_id: UUID, photo: dict) -> None:
    try:
        ...
        logger.error(f"Failed to upload photos for {profile_id}: {e} ")

        for photo_data in photo.values():
