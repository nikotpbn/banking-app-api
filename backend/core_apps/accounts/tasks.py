...
def detect_suspicious_activities():
    LARGE_TRANSACTION_THRESHOLD = Decimal(os.environ.get("LARGE_TRANSACTION_THRESHOLD"))

    FREQUENT_TRANSACTION_THRESHOLD = int(os.environ.get("FREQUENT_TRANSACTION_THRESHOLD"))

    TIME_WINDOW_HOURS = int(os.environ.get("TIME_WINDOW_HOURS"))
